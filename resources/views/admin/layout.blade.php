...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('ensiklopedia.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('ensiklopedia.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('ensiklopedia.png') }}">
